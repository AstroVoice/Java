...
public class Tank extends GameObject implements Poolable {
    ...
    public Tank(GameController gc) {
        ...
        this.BoxCharged = Assets.getInstance().getAssetManager().get("fonts/font32.ttf");
    }
    ...
    public void render(SpriteBatch batch) {
        ...
        BoxCharged.draw(batch, Integer.toString(container), position.x,position.y + 80, 40,1,true);
